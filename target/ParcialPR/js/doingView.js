...
class doingView{
    ...
    deleteNote = () =>{
        ...
        xhr.open('DELETE', 'http://localhost:8080/ParcialPR_war/api/doing/delete/'+this.note.id);
        xhr.send();
    }
    ...
    nextState = () =>{
        ...
        xhr.open('POST', 'http://localhost:8080/ParcialPR_war/api/done/create');
    ...
    render = () =>{
        ...
        component.id = 'doingComponent' + this.note.id;
